...
def make(post: dict, o: dict, max_lines: int = card.MAX_LINES, **shape) -> Shot:
    """`shape` passes col and media_h through to card.layout."""
    L = card.layout(post, "dark", o["shot_stats"], max_lines=max_lines, **shape)
